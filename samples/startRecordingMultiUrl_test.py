...
def index(request):
    ...
    recordURLobj5 = RecordUrlTuple(url = "http://192.168.26.88:8080/FileUpload/uploadFile3", sessionToken = "ThisisafakesessionTokenforpythonstartRecordingMultiUrl", username = "fakename3", password="fakepassword", method="POST").json
    ...
    t.startRecording([recordURLobj1, recordURLobj5, recordURLobj2, recordURLobj3, recordURLobj4], formamt = 'audio/wav', transcriptionID = "20170601startRecording", transcriptionEmailFormat = "plain", transcriptionLanguage = "en-usa", transcriptionOutURI = "http://12b12d1b.ngrok.io/FileUpload/receiveJson") 
...
run_itty(server='wsgiref', host='127.0.0.1', port=8085)
